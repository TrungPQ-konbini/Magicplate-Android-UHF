package com.konbini.magicplateuhf.utils.sunmi;
...
public class SunmiPrintHelper {
    ...
    public void printText(String content, float size, boolean isBold, boolean isUnderLine) {
        ...
        try {
            try {
                ...
                if (isBold) {
                    sunmiPrinterService.sendRAWData(com.konbini.magicplateuhf.utils.sunmi.ESCUtil.boldOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.konbini.magicplateuhf.utils.sunmi.ESCUtil.boldOff(), null);
                }
            }
            try {
                ...
                if (isUnderLine) {
                    sunmiPrinterService.sendRAWData(com.konbini.magicplateuhf.utils.sunmi.ESCUtil.underlineWithOneDotWidthOn(), null);
                } else {
                    sunmiPrinterService.sendRAWData(com.konbini.magicplateuhf.utils.sunmi.ESCUtil.underlineOff(), null);
                }
            }
     ...
     */
    public void printTable(String[] txts, int[] width, int[] align, boolean isBold) {
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
